%% Singular Value Decomposition - 1D Linear Regression
% Graham Williams | grwi2594@colorado.edu

% Use SVD to compute the regression curve to noisy data.
% Show other methods of finding the regression slope.
...
set(gca,'FontSize',13)
print('-dpng', 'svd_pinv_1D_regression')
